...
map("n", "<space>h", "<cmd>lua vim.lsp.buf.hover()<CR>", { desc = "hover information [LSP]" })
map("n", "gi", "<cmd>lua vim.lsp.buf.implementation()<CR>", { desc = "goto implementation [LSP]" })
map("n", "<C-k>", "<cmd>lua vim.lsp.buf.signature_help()<CR>", { desc = "signature help [LSP]" })
map("n", "gR", '<cmd>lua require("lsp.rename").rename()<CR>', { desc = "rename [LSP]" })
map("n", "<space>wa", "<cmd>lua vim.lsp.buf.add_workspace_folder()<CR>", opts)
map("n", "<space>wr", "<cmd>lua vim.lsp.buf.remove_workspace_folder()<CR>", opts)
map("n", "<space>wl", "<cmd>lua print(vim.inspect(vim.lsp.buf.list_workspace_folders()))<CR>", opts)
map("n", "<space>D", "<cmd>lua vim.lsp.buf.type_definition()<CR>", { desc = "goto type definition [LSP]" })
map("n", "<space>rn", "<cmd>lua vim.lsp.buf.rename()<CR>", { desc = "rename [LSP]" })
map("n", "<space>ca", "<cmd>lua vim.lsp.buf.code_action()<CR>", { desc = "code actions [LSP]" })
